...
let snakeTexture = textureLoader.load('/public/assets/textures/snake.jpg');
...
function init() {
    ...
    //load grass
    let textureLoader = new THREE.TextureLoader();
    let grassTexture = textureLoader.load('/public/assets/textures/grass.jpg');
...
function moveSnake() {
    ...
    if (snake[0].position.distanceTo(snack.position) < 0.1) {
        ...
        let newSegment = createCube(lastSegment.position.x, lastSegment.position.y, lastSegment.position.z, 0x00ff00);
